...
public class SampleMahoujinProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				DiesbleachMod.LOGGER.warn("Failed to load dependency world for procedure SampleMahoujin!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				DiesbleachMod.LOGGER.warn("Failed to load dependency x for procedure SampleMahoujin!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				DiesbleachMod.LOGGER.warn("Failed to load dependency y for procedure SampleMahoujin!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				DiesbleachMod.LOGGER.warn("Failed to load dependency z for procedure SampleMahoujin!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				DiesbleachMod.LOGGER.warn("Failed to load dependency entity for procedure SampleMahoujin!");
			return;
		}
