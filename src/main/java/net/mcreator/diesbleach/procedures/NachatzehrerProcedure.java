...
import net.mcreator.diesbleach.particle.NachatzehrerkageParticle;
...
public class NachatzehrerProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				DiesbleachMod.LOGGER.warn("Failed to load dependency world for procedure Nachatzehrer!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				DiesbleachMod.LOGGER.warn("Failed to load dependency x for procedure Nachatzehrer!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				DiesbleachMod.LOGGER.warn("Failed to load dependency y for procedure Nachatzehrer!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				DiesbleachMod.LOGGER.warn("Failed to load dependency z for procedure Nachatzehrer!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				DiesbleachMod.LOGGER.warn("Failed to load dependency entity for procedure Nachatzehrer!");
			return;
		}
			...
			for (Entity entityiterator : _entfound) {
				if (((Entity) world
					...
					if (entityiterator instanceof LivingEntity)
						((LivingEntity) entityiterator).addPotionEffect(new EffectInstance(Effects.SLOWNESS, (int) 100, (int) 100, (false), (false)));
					r = 1;
					angle = 0;
					k = 100;
					for (int index0 = 0; index0 < (int) (k); index0++) {
						world.addParticle(NachatzehrerkageParticle.particle, (entityiterator.getPosX() + r * Math.cos(Math.toRadians(angle))),
					...
					for (int index1 = 0; index1 < (int) (5); index1++) {
						...
						for (int index2 = 0; index2 < (int) (k); index2++) {
							world.addParticle(NachatzehrerkageParticle.particle, xx, (entityiterator.getPosY()), zz, 0, 0.2, 0);
							xx = (xx + dx);
							zz = (zz + dz);
						}
						i = (i + 72);
